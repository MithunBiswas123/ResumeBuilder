...
export default function Horizon({ resumeData }) {
  ...
  return (
    <div className="bg-white w-full h-full font-sans text-gray-800 max-w-[1000px] mx-auto relative">
      {/* Unique diagonal header - keeping as is */}
      <div className="relative overflow-hidden">
        <div 
          className="absolute top-0 left-0 right-0 h-64 bg-teal-600"
          style={{
            clipPath: "polygon(0 0, 100% 0, 100% 70%, 0 100%)"
          }}
        />
        <div 
          className="absolute top-0 left-0 right-0 h-64 bg-teal-500 opacity-80"
          style={{
        ...
        <div className="relative z-10 px-8 pt-10 pb-20">
          ...
          {/* Contact info with horizontal layout */}
          <div className="flex flex-wrap gap-x-8 gap-y-2 mt-6">
            {personalInfo?.email && (
              <div className="flex items-center">
                <FaEnvelope className="mr-2 text-teal-200" size={14} />
            ...
            {personalInfo?.phone && (
              <div className="flex items-center">
                <FaPhone className="mr-2 text-teal-200" size={14} />
            ...
            {personalInfo?.location && (
              <div className="flex items-center">
                <FaMapMarkerAlt className="mr-2 text-teal-200" size={14} />
            ...
            {personalInfo?.linkedin && (
              ...
              >
                <FaLinkedin className="mr-2 text-teal-200" size={14} />
                <span>LinkedIn</span>
              </a>
            )}
            ...
            {personalInfo?.github && (
              <a
                ...
                className="flex items-center text-white hover:text-teal-200 transition-colors"
              >
                <FaGithub className="mr-2 text-teal-200" size={14} />
                <span>GitHub</span>
              </a>
            )}
          </div>
      ...
      <div className="px-8">
        ...
        {personalInfo?.summary && (
          <section className="py-8 relative">
            <h2 className="text-xl font-bold mb-4 text-gray-800 border-b border-teal-100 pb-2">
          ...
          <section className="py-6 relative">
            ...
            <div className="flex flex-wrap gap-3">
              {skills.map((skill, index) => (
                <div 
                  key={index} 
                  className="px-4 py-2 bg-gray-50 border border-teal-100 text-gray-800 rounded-md shadow-sm"
                >
                  {skill}
                </div>
              ))}
        ...
        {/* Experience - more elegant timeline */}
        {experience?.length > 0 && (
          <section className="py-6 relative">
            <h2 className="text-xl font-bold mb-4 text-gray-800 border-b border-teal-100 pb-2">
        ...
        {/* Education - cleaner layout */}
        {education?.length > 0 && (
          <section className="py-6 relative">
            <h2 className="text-xl font-bold mb-4 text-gray-800 border-b border-teal-100 pb-2">
              <span className="text-teal-600">Education</span>
            </h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {education.map((edu, index) => (
                <div key={index} className="bg-gray-50 p-4 rounded-lg border border-teal-50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 py-6">
          ...
          {achievements?.length > 0 && (
            <section>
              <h2 className="text-xl font-bold mb-4 text-gray-800 border-b border-teal-100 pb-2">
                <span className="text-teal-600">Achievements</span>
              </h2>
