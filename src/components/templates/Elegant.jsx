...
//   const { personalInfo, experience, education, skills, projects, aiHighlights } = resumeData || {};
...
//             <h2 className="text-lg font-semibold text-gray-800 border-b border-gray-200 pb-2 mb-3">Professional Summary</h2>
...
//               <div className="mb-4">
//                 <h3 className="text-md font-medium text-gray-700 mb-2">Key Skills</h3>
//                 <div className="flex flex-wrap gap-2">
//                   {aiHighlights.keySkills.map((skill, idx) => (
//                     <span key={idx} className="px-3 py-1 bg-blue-50 text-blue-700 text-sm rounded-md border border-blue-100">
//                       {skill}
//                     </span>
//                   ))}
//                 </div>
...
//         {experience?.length > 0 && (
//           <section className="mb-8">
//             <h2 className="text-lg font-semibold text-gray-800 border-b border-gray-200 pb-2 mb-3">Professional Experience</h2>
//             {experience.map((job, index) => (
//               <div key={index} className="mb-5">
//                 <div className="flex flex-col md:flex-row md:justify-between md:items-baseline mb-1">
//                   <h3 className="text-base font-medium text-gray-800">{job.title || job.position}</h3>
//                   <span className="text-sm text-gray-600">{job.startDate} - {job.endDate || 'Present'}</span>
//                 </div>
//                 <p className="text-base text-blue-700 mb-2">{job.company}{job.location ? `, ${job.location}` : ''}</p>
...
//         {skills?.length > 0 && (
//           <section className="mb-8">
//             <h2 className="text-lg font-semibold text-gray-800 border-b border-gray-200 pb-2 mb-3">Skills</h2>
//             <div className="flex flex-wrap gap-2">
//               {skills.map((skill, index) => (
//                 <span key={index} className="px-3 py-1 bg-gray-100 text-gray-800 text-sm rounded-md">
//                   {skill}
//                 </span>
//               ))}
//             </div>
...
//         {education?.length > 0 && (
//           <section className="mb-8">
//             <h2 className="text-lg font-semibold text-gray-800 border-b border-gray-200 pb-2 mb-3">Education</h2>
...
//                 </div>
//                 <p className="text-base text-blue-700">{edu.school}{edu.location ? `, ${edu.location}` : ''}</p>
//               </div>
//             ))}
//           </section>
//         )}
...
//         {projects?.length > 0 && (
//           <section>
//             <h2 className="text-lg font-semibold text-gray-800 border-b border-gray-200 pb-2 mb-3">Projects</h2>
//             <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
//               {projects.map((project, index) => (
//                 <div key={index} className="bg-gray-50 p-4 rounded border border-gray-200 hover:shadow-sm transition-shadow">
//                   <h3 className="text-base font-medium text-gray-800 mb-2">{project.title}</h3>
//                   <p className="text-sm text-gray-700 mb-3">{project.description}</p>

//                   {project.technologies && project.technologies.length > 0 && (
//                     <div className="flex flex-wrap gap-1 mb-2">
//                       {project.technologies.map((tech, idx) => (
//                         <span key={idx} className="text-xs px-2 py-1 bg-gray-200 rounded-md text-gray-700">
//                           {tech}
//                         </span>
//                       ))}
//                     </div>
...
//       <footer className="bg-gray-50 border-t border-gray-200 p-4 text-center text-gray-500 text-xs">
